...
import mx.edu.utng.primaria.activities.listener.Months;
import mx.edu.utng.primaria.activities.listener.SeasonsListenerActivity;
...
public class MonthsSeasons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activitiesList.add(new Activities(R.drawable.icon_android, "Months", "Listening",R.color.enable));
        activitiesList.add(new Activities(R.drawable.icon_android, "The Seasons", "Listening",R.color.enable));
